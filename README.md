## pinocchio (humble) - 4.1.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/yfipm26gps6649vc1n9p5wd0w6ix3nrp-python3.13-bloom-0.14.3/bin/bloom-release -r humble pinocchio` on `Tue, 07 Jul 2026 16:36:55 -0000`
...
## pinocchio (jazzy) - 4.1.0-1

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/yfipm26gps6649vc1n9p5wd0w6ix3nrp-python3.13-bloom-0.14.3/bin/bloom-release -r jazzy pinocchio` on `Tue, 07 Jul 2026 16:31:22 -0000`
...
## pinocchio (kilted) - 4.1.0-1

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/yfipm26gps6649vc1n9p5wd0w6ix3nrp-python3.13-bloom-0.14.3/bin/bloom-release -r kilted pinocchio` on `Tue, 07 Jul 2026 16:23:53 -0000`
...
## pinocchio (lyrical) - 4.1.0-1

The packages in the `pinocchio` repository were released into the `lyrical` distro by running `/nix/store/yfipm26gps6649vc1n9p5wd0w6ix3nrp-python3.13-bloom-0.14.3/bin/bloom-release -r lyrical pinocchio` on `Tue, 07 Jul 2026 16:16:31 -0000`
...
## pinocchio (lyrical) - 4.0.0-1

The packages in the `pinocchio` repository were released into the `lyrical` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r lyrical pinocchio` on `Tue, 12 May 2026 14:01:36 -0000`
...
## pinocchio (rolling) - 4.0.0-2

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r rolling pinocchio` on `Tue, 12 May 2026 13:51:20 -0000`
...
## pinocchio (rolling) - 4.0.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r rolling pinocchio` on `Tue, 12 May 2026 13:41:46 -0000`
...
## pinocchio (kilted) - 4.0.0-2

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r kilted pinocchio` on `Tue, 12 May 2026 09:43:09 -0000`
...
## pinocchio (kilted) - 4.0.0-1

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r kilted pinocchio` on `Tue, 12 May 2026 09:36:29 -0000`
...
## pinocchio (jazzy) - 4.0.0-2

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r jazzy pinocchio` on `Tue, 12 May 2026 09:28:50 -0000`
...
## pinocchio (jazzy) - 4.0.0-1

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r jazzy pinocchio` on `Tue, 12 May 2026 09:14:47 -0000`
...
## pinocchio (humble) - 4.0.0-2

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r humble pinocchio` on `Mon, 11 May 2026 17:54:09 -0000`
...
## pinocchio (humble) - 4.0.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/yr02v08v8dzvm5cbhvlbag590psbayxw-python3.13-bloom-0.14.3/bin/bloom-release -r humble pinocchio` on `Mon, 11 May 2026 17:40:53 -0000`
...
## pinocchio (humble) - 3.9.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/rhf364g29a4h0nwdhf8lv17y9jh0i5gj-python3.13-bloom-0.13.0/bin/bloom-release -r humble pinocchio` on `Tue, 27 Jan 2026 14:05:25 -0000`
...
## pinocchio (jazzy) - 3.9.0-1

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/rhf364g29a4h0nwdhf8lv17y9jh0i5gj-python3.13-bloom-0.13.0/bin/bloom-release -r jazzy pinocchio` on `Tue, 27 Jan 2026 13:59:47 -0000`
...
## pinocchio (kilted) - 3.9.0-1

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/rhf364g29a4h0nwdhf8lv17y9jh0i5gj-python3.13-bloom-0.13.0/bin/bloom-release -r kilted pinocchio` on `Tue, 27 Jan 2026 13:44:42 -0000`
...
## pinocchio (rolling) - 3.9.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/rhf364g29a4h0nwdhf8lv17y9jh0i5gj-python3.13-bloom-0.13.0/bin/bloom-release -r rolling pinocchio` on `Tue, 27 Jan 2026 08:49:40 -0000`
...
## pinocchio (rolling) - 3.8.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Tue, 14 Oct 2025 17:50:14 -0000`
...
## pinocchio (kilted) - 3.8.0-1

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r kilted pinocchio` on `Tue, 14 Oct 2025 17:25:09 -0000`
...
## pinocchio (rolling) - 3.6.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Mon, 23 Jun 2025 06:42:57 -0000`
...
## pinocchio (kilted) - 3.6.0-1

The packages in the `pinocchio` repository were released into the `kilted` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r kilted pinocchio` on `Mon, 23 Jun 2025 06:36:04 -0000`
...
The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy pinocchio` on `Mon, 23 Jun 2025 06:20:28 -0000`
...
## pinocchio (humble) - 3.6.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/rrnp44mx5czg1688ynsgf6aibjf0zcq2-python3.12-bloom-0.12.0/bin/bloom-release -r humble pinocchio` on `Mon, 23 Jun 2025 06:15:41 -0000`
...
## pinocchio (rolling) - 3.5.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/fzk45mxsx3ihl63w4mhvkzhdb4hj8jy1-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Fri, 25 Apr 2025 00:00:54 -0000`
...
## pinocchio (jazzy) - 3.5.0-1

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/fzk45mxsx3ihl63w4mhvkzhdb4hj8jy1-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy pinocchio` on `Thu, 24 Apr 2025 18:35:27 -0000`
...
## pinocchio (humble) - 3.5.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/fzk45mxsx3ihl63w4mhvkzhdb4hj8jy1-python3.12-bloom-0.12.0/bin/bloom-release -r humble pinocchio` on `Thu, 24 Apr 2025 18:27:46 -0000`
...
The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r humble pinocchio` on `Sat, 22 Feb 2025 11:13:05 -0000`
...
The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy pinocchio` on `Sat, 22 Feb 2025 11:00:00 -0000`
...
## pinocchio (rolling) - 3.4.0-3

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Sat, 22 Feb 2025 10:38:29 -0000`
...
The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r humble pinocchio` on `Thu, 20 Feb 2025 11:17:40 -0000`
...
The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy pinocchio` on `Thu, 20 Feb 2025 11:13:08 -0000`
...
## pinocchio (rolling) - 3.4.0-2

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Thu, 20 Feb 2025 11:05:54 -0000`
...
## pinocchio (rolling) - 3.4.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/vf5ngc0mmfvwi831knnc30wklbl473kb-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Thu, 20 Feb 2025 10:57:27 -0000`
...
## pinocchio (rolling) - 3.3.0-1

The packages in the `pinocchio` repository were released into the `rolling` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r rolling pinocchio` on `Sun, 08 Dec 2024 20:39:06 -0000`
...
## pinocchio (jazzy) - 3.3.0-1

The packages in the `pinocchio` repository were released into the `jazzy` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r jazzy pinocchio` on `Sun, 08 Dec 2024 20:12:02 -0000`
...
## pinocchio (iron) - 3.3.0-1

The packages in the `pinocchio` repository were released into the `iron` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r iron -d pinocchio` on `Sun, 08 Dec 2024 20:03:31 -0000`
...
## pinocchio (humble) - 3.3.0-1

The packages in the `pinocchio` repository were released into the `humble` distro by running `/nix/store/ai12rs6v9d4pfsj8m2k668zbnr7z8l57-python3.12-bloom-0.12.0/bin/bloom-release -r humble -d pinocchio` on `Sun, 08 Dec 2024 19:45:14 -0000`
